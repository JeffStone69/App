...
with gr.Blocks(title="XForge Trader v9.2", theme=gr.themes.Soft()) as app:
    ...
    with gr.Tab("📊 History"): gr.Button("Show").click(hist, [gr.Textbox("AAPL"), gr.Slider(100)], gr.Dataframe())
    with gr.Tab("🚚 Shipping+Cost"): gr.Button("Calculate").click(ship_cost, [gr.Textbox("AAPL"), gr.Number(100)], gr.Textbox())
    with gr.Tab("🧠 SIM on History"): gr.Button("Run SIM").click(sim_hist, [gr.Textbox("AAPL"), gr.Slider(30)], gr.Textbox())
