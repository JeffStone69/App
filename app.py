...
def call_xai_for_improvement(current_code, user_prompt):
    ...
    try:
        ...
        system_prompt = "You are an expert Python developer specializing in robust, self-improving applications. Analyze the provided script and improve it according to the user's request. Focus on: better error handling, logging, modularity, performance, security, and new features. Output ONLY the complete, runnable Python code. No explanations, no markdown fences."
